                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                {{-- <span class="float-right display-5 opacity-5"><i class="fa fa-people"></i></span> --}}
                                <span class="float-right display-5 opacity-5"><i class="icon-graduation menu-icon"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Total Instructors</h3>
                                <div class="d-inline-block">
